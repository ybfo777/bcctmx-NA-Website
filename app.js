  ...
  ccs: {
    metric: {
      ...
      rows: [
        ...
        ['2',  '6.54', '33.62', '849', '—', '268.5', '2.442'],
        ['3',  '5.83', '26.67', '918', '—', '212.9', '3.079'],
        ['4',  '5.19', '21.15', '956', '—', '168.9', '3.882'],
        ['5',  '4.62', '16.77', '956', '—', '133.9', '4.897'],
        ['6',  '4.11', '13.30', '956', '—', '106.2', '6.174'],
        ['7',  '3.67', '10.55', '956', '—', '84.26', '7.781'],
        ['8',  '3.26', '8.37', '875', '1.0', '66.82', '9.812'],
        ['9',  '2.91', '6.63', '918', '—', '52.96', '12.38'],
        ['10', '2.59', '5.26', '956', '1.0', '42.02', '15.60'],
        ['11', '2.30', '4.17', '875', '1.0', '33.29', '19.70'],
        ['12', '2.05', '3.31', '956', '1.0', '26.42', '24.82'],
        ['13', '1.83', '2.63', '875', '1.5', '20.98', '31.26'],
        ['14', '1.63', '2.08', '875', '1.5', '16.63', '39.43'],
        ['15', '1.45', '1.65', '875', '1.5', '13.19', '49.70'],
        ['16', '1.29', '1.31', '875', '1.5', '10.44', '62.79'],
        ['17', '1.15', '1.04', '875', '1.5', '8.304', '78.96'],
        ['18', '1.02', '0.823', '875', '1.0', '6.572', '99.76'],
        ['19', '0.91', '0.653', '875', '1.0', '5.215', '125.7'],
        ['20', '0.81', '0.519', '875', '1.0', '4.144', '158.2'],
        ['21', '0.72', '0.412', '875', '1.0', '3.287', '199.5'],
        ['22', '0.64', '0.324', '875', '1.0', '2.590', '253.1'],
        ['23', '0.57', '0.259', '875', '1.0', '2.067', '317.2'],
        ['24', '0.51', '0.205', '875', '1.0', '1.635', '401.0'],
        ['25', '0.45', '0.162', '875', '1.0', '1.297', '505.7'],
        ['26', '0.40', '0.129', '875', '1.0', '1.028', '637.6'],
        ['27', '0.36', '0.102', '875', '1.0', '0.815', '804.0'],
      ],
    },
  },
};
...
function ccsImperial() {
  ...
  return {
    ...
    rows: metricRows.map(([awg, dia, area, strength, elong, weight, res]) => [
      awg,
      f(parseFloat(dia) / 25.4, 4),
      f(parseFloat(area) / 645.16, 4),
